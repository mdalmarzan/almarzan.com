...
const CursorGrid = ({
  ...
  useEffect(() => {
    ...
    // Use window coordinates because the overlay has pointer-events: none
    const toLocal = e => [e.clientX, e.clientY];
    ...
    // Listen on window so it works with pointer-events: none
